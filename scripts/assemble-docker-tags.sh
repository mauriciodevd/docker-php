...
IFS=',' read -ra DOCKER_REGISTRY_REPOSITORIES <<< "${DOCKER_REGISTRY_REPOSITORIES:-"docker.io/mauriciodulcce/php,ghcr.io/mauriciodulce/php"}"
...
help_menu() {
    ...
    echo "  DOCKER_REGISTRY_REPOSITORIES  Names of images to tag (default: 'docker.io/mauriciodulcce/php' 'ghcr.io/mauriciodulce/php')"
